...
const roleLabels = {
  to_truong: { label: "Tổ trưởng", color: "bg-primary text-primary-foreground" },
  can_bo_ql: { label: "Cán bộ quản lý", color: "bg-accent text-accent-foreground" },
  cu_dan: { label: "Cư dân", color: "bg-success text-success-foreground" },
  khach: { label: "Khách", color: "bg-muted text-muted-foreground" },
};
